...
class JEventsConnector extends JSMCalendar
{
	...
	private static function _checkJEvents()
	{
		...
		{
			self::_raiseError('Required files not found! This connector needs JEvents 1.5.2 to be installed');
		...
		{
			self::_raiseError('Required class not found! This connector needs JEvents 1.5.2 installed');

			return false;
		}

		if (!is_callable(array(self::$jevent, 'getCalendarData')))
		{
			self::_raiseError('Required function "getRangeData" is not callable! This connector needs JEvents 1.5.2 installed');
