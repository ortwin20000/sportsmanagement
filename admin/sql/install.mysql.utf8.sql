...
CREATE  TABLE IF NOT EXISTS `#__sportsmanagement_club` (
  ...
  `founded_timestamp` BIGINT( 20 ) NOT NULL DEFAULT  '0',
  `dissolved_timestamp` BIGINT( 20 ) NOT NULL DEFAULT  '0',
...
CREATE  TABLE IF NOT EXISTS `#__sportsmanagement_match` (
  ...
  `match_timestamp` BIGINT( 20 ) NOT NULL DEFAULT  '0',
...
CREATE  TABLE IF NOT EXISTS `#__sportsmanagement_person` (
  ...
  `referee_type` VARCHAR(50) NULL DEFAULT NULL,
  `referee_valid` DATE NOT NULL DEFAULT '0000-00-00' ,
  `coach_type` VARCHAR(50) NULL DEFAULT NULL,
  `coach_valid` DATE NOT NULL DEFAULT '0000-00-00' ,
  ...
  `hits` INT(11) NOT NULL DEFAULT '0' ,
  `modified_hits` INT(11) NOT NULL DEFAULT '0' ,
  `birthday_timestamp` BIGINT( 20 ) NOT NULL DEFAULT  '0',
  `deathday_timestamp` BIGINT( 20 ) NOT NULL DEFAULT  '0',
...
CREATE  TABLE IF NOT EXISTS `#__sportsmanagement_project` (
  ...
  `modified_hits` INT(11) NOT NULL DEFAULT '0' ,
  `cr_picture` varchar(255) DEFAULT NULL,
  `modified_timestamp` BIGINT( 20 ) NOT NULL DEFAULT  '0',
